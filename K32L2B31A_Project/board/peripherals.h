...
#define ADC0_TEMP 0U
/* Definition of custom name for ADC0 configuration #1 (channel 13, control group 0) */
#define ADC0_PRES 1U
/* Definition of custom name for ADC0 configuration #2 (channel 12, control group 0) */
#define ADC0_LUM 2U
