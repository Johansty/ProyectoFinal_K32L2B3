...
- {pin_num: '28', pin_signal: PTA12/TPM1_CH0, label: RELE_IN1, identifier: RELE_IN1}
- {pin_num: '26', pin_signal: PTA4/I2C1_SDA/TPM0_CH1/NMI_b, label: 'J1[10]/D4/SW1', identifier: EXT_SDA}
...
- {pin_num: '29', pin_signal: PTA13/TPM1_CH1, label: RELE_IN2, identifier: RELE_IN2}
...
- {pin_num: '11', pin_signal: ADC0_DP3/ADC0_SE3/PTE22/TPM2_CH0/UART2_TX/FXIO0_D6, label: 'J4[5]/DIFF_ADC1_DP', identifier: SENSOR_DE_LUZ;LUM_MICRO}
...
- {pin_num: '37', pin_signal: LCD_P2/ADC0_SE12/PTB2/I2C0_SCL/TPM2_CH0, label: 'J4[6]/A2/LCD_P2', identifier: LUM_EXT}
...
- {pin_num: '25', pin_signal: PTA3/I2C1_SCL/TPM0_CH0/SWD_DIO, label: 'J11[2]/SWD_DIO_TGTMCU', identifier: EXT_SCL}
...
void BOARD_InitBUTTONSPins(void)
{
    ...
    gpio_pin_config_t EXT_SDA_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA4 (pin 26)  */
    GPIO_PinInit(BOARD_EXT_SDA_GPIO, BOARD_EXT_SDA_PIN, &EXT_SDA_config);
    ...
    PORT_SetPinMux(BOARD_EXT_SDA_PORT, BOARD_EXT_SDA_PIN, kPORT_MuxAsGpio);
...
- pin_list:
  - {pin_num: '11', peripheral: ADC0, signal: 'SE, 3', pin_signal: ADC0_DP3/ADC0_SE3/PTE22/TPM2_CH0/UART2_TX/FXIO0_D6, identifier: LUM_MICRO}
...
void BOARD_InitADCPins(void)
{
    ...
    PORT_SetPinMux(BOARD_INITADCPINS_LUM_EXT_PORT, BOARD_INITADCPINS_LUM_EXT_PIN, kPORT_PinDisabledOrAnalog);

    /* PORTE22 (pin 11) is configured as ADC0_SE3 */
    PORT_SetPinMux(BOARD_INITADCPINS_LUM_MICRO_PORT, BOARD_INITADCPINS_LUM_MICRO_PIN, kPORT_PinDisabledOrAnalog);
}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitSTH31_I2CPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitRELESPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_InitRELESPins(void)
{
    ...
    gpio_pin_config_t RELE_IN1_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA12 (pin 28)  */
    GPIO_PinInit(BOARD_INITRELESPINS_RELE_IN1_GPIO, BOARD_INITRELESPINS_RELE_IN1_PIN, &RELE_IN1_config);

    gpio_pin_config_t RELE_IN2_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA13 (pin 29)  */
    GPIO_PinInit(BOARD_INITRELESPINS_RELE_IN2_GPIO, BOARD_INITRELESPINS_RELE_IN2_PIN, &RELE_IN2_config);

    /* PORTA12 (pin 28) is configured as PTA12 */
    PORT_SetPinMux(BOARD_INITRELESPINS_RELE_IN1_PORT, BOARD_INITRELESPINS_RELE_IN1_PIN, kPORT_MuxAsGpio);

    /* PORTA13 (pin 29) is configured as PTA13 */
    PORT_SetPinMux(BOARD_INITRELESPINS_RELE_IN2_PORT, BOARD_INITRELESPINS_RELE_IN2_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
