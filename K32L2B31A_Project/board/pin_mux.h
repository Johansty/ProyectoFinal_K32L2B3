...
/* Symbols to be used with GPIO driver */
#define BOARD_EXT_SDA_FGPIO FGPIOA             /*!<@brief FGPIO peripheral base pointer */
#define BOARD_EXT_SDA_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define BOARD_EXT_SDA_GPIO_PIN_MASK (1U << 4U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_EXT_SDA_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_EXT_SDA_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_EXT_SDA_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                               /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_INITADCPINS_LUM_MICRO_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITADCPINS_LUM_MICRO_PIN 22U                   /*!<@brief PORT pin number */
#define BOARD_INITADCPINS_LUM_MICRO_PIN_MASK (1U << 22U)      /*!<@brief PORT pin mask */
                                                              /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_INITADCPINS_LUM_EXT_PORT PORTB               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITADCPINS_LUM_EXT_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_INITADCPINS_LUM_EXT_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                           /* @} */
 ...
 *
 */
void BOARD_InitSTH31_I2CPins(void);

/*! @name PORTA12 (number 28), RELE_IN1
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_INITRELESPINS_RELE_IN1_FGPIO FGPIOA              /*!<@brief FGPIO peripheral base pointer */
#define BOARD_INITRELESPINS_RELE_IN1_GPIO GPIOA                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITRELESPINS_RELE_IN1_GPIO_PIN_MASK (1U << 12U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITRELESPINS_RELE_IN1_PORT PORTA                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITRELESPINS_RELE_IN1_PIN 12U                   /*!<@brief PORT pin number */
#define BOARD_INITRELESPINS_RELE_IN1_PIN_MASK (1U << 12U)      /*!<@brief PORT pin mask */
                                                               /* @} */

/*! @name PORTA13 (number 29), RELE_IN2
  @{ */

/* Symbols to be used with GPIO driver */
#define BOARD_INITRELESPINS_RELE_IN2_FGPIO FGPIOA              /*!<@brief FGPIO peripheral base pointer */
#define BOARD_INITRELESPINS_RELE_IN2_GPIO GPIOA                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITRELESPINS_RELE_IN2_GPIO_PIN_MASK (1U << 13U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITRELESPINS_RELE_IN2_PORT PORTA                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITRELESPINS_RELE_IN2_PIN 13U                   /*!<@brief PORT pin number */
#define BOARD_INITRELESPINS_RELE_IN2_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                                               /* @} */
